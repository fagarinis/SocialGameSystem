...
public class Parameters {
	...
	public final static int		NUMBER_OF_REPRODUCE 	= 7;					//quante volte un giocatore puo' replicarsi (con successo)
	public final static int		NEIGHBOURS_TO_REPRODUCE = 3;					//quanti giocatori vicini deve avere una cella per permettere la nascita
	 ...
	 *  implementazione con 9 relazioni dove 0 è la posizione del giocatore ed e' girato verso l'alto:<br>
	 *  	1 2 3 <br>
	 *  	4 ^ 5 <br>
	 *		6 7 8
	 */
